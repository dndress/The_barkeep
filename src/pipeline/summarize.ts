...
function buildPrompt(opts: {
  ...
  return [
    ...
    '    - importance: 1 (trivial) to 10. Score on BOTH narrative weight AND visual iconicity — whichever is higher wins, do not average. The highest-scored event is used to generate a single illustration for the session, so favor moments a painter would choose.',
    '        VISUAL ICONICITY TIERS (treat these as a floor):',
    '          * Combat with a named foe, boss fight, party-vs-monster, or any pitched battle → AT LEAST 9.',
    '          * Supernatural manifestation, ritual cast, summoning, divine intervention, magical catastrophe → AT LEAST 8.',
    '          * Dramatic confrontation (standoff, intimidation, surrender, betrayal, oath sworn, revealed identity) involving multiple PCs → AT LEAST 7.',
    '          * Environmental spectacle (collapse, storm, vista reveal, fire, flood) with PCs reacting → AT LEAST 7.',
    '          * Quiet roleplay, planning, dialogue, shopping, downtime, travel description → AT MOST 6, regardless of plot weight.',
    '        NARRATIVE WEIGHT (use this independently):',
    '          * Campaign-defining decision, major NPC introduced, faction alliance/break, character arc resolution → AT LEAST 8.',
    '          * Quest hook accepted/completed, important lore revealed, new location unlocked → 6–7.',
    '          * Minor information, side-conversation, routine encounter outcome → 1–4.',
    '        If a session is heavy on dialogue and light on action, the BEST roleplay moment (most charged confrontation, most dramatic reveal) still gets at least an 8 — there is always one "iconic" moment per session, even a quiet one. Never leave the top scorer below 8.',
    '        If a session has multiple combats, the most consequential one (boss fight, climactic battle, party in greatest danger) scores 10. Lesser combats score 8–9.',
